...
#define STRING_CONFIG_H_AUTHOR "(Zizi, Ender-3, Direct, BLTouch)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "v201102-1"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 38.2, 0, -0.67 }
